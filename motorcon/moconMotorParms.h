...
class MotorParms : public Ris::BaseCmdLineParms
{
public:
...
#ifdef _SOMEEMULATORPARMS_CPP_
   MotorParms gMotorParms;
#else
   extern MotorParms gMotorParms;
#endif
